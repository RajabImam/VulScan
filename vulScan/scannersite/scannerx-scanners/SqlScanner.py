...
class SqlScanner:
    def __init__(self, url):
        ...
        self.result = {'name': 'Sql Injection', 'status': 'Not Found', 'message': ''}
        ...
        for form in forms:
            ...
            for c in "\"'":
                ...
                if self.vulnerable(res):
                    self.result['status'] = 'Found'
                    self.result['message'] = "[+] Detected {len(forms)} forms on {self.url}. [+] SQL Injection discovered on {self.url}"
                    ...
                    self.result['message'] = "No SQL Injection found"
